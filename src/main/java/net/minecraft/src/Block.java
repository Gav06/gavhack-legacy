...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        return par5 == 0 && this.minY > 0.0D || (par5 == 1 && this.maxY < 1.0D || (par5 == 2 && this.minZ > 0.0D || (par5 == 3 && this.maxZ < 1.0D || (par5 == 4 && this.minX > 0.0D ? true : (par5 == 5 && this.maxX < 1.0D ? true : !par1IBlockAccess.isBlockOpaqueCube(par2, par3, par4))))));
    }
    ...
    {
        AxisAlignedBB var8 = this.getCollisionBoundingBoxFromPool(par1World, x, y, z);
